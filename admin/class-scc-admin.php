...
class SCC_Admin {
	...
	public static function register_settings() {
		...
		foreach ( array(
			...
			'scc_modal_title'           => 'sanitize_text_field',
			'scc_modal_intro'           => 'sanitize_textarea_field',
			'scc_modal_save_label'      => 'sanitize_text_field',
			'scc_modal_deny_label'      => 'sanitize_text_field',
